...
class TestPayrollStructureBase(TestPayslipBase):
    ...
    def get_deduction_id(self, ref, module='l10n_ca_hr_payroll'):
        """
    ...
    def get_benefit_id(self, ref, module='l10n_ca_hr_payroll'):
        """
...
class TestCanadaPayrollStructure(TestPayrollStructureBase):
    ...
    def test_create_payslip_low_wage(self):
        ...
        self.create_worked_days([
            ...
            ('2014-01-01', '2014-01-05', self.job_activity_id, 40, 20),
        ])
        self.create_inputs([
    ...
    def test_create_payslip_end_of_year(self):
        ...
        for wd in [
            # (date_from, date_to, activity_id, nb_hours, hourly_rate)
            ('2014-01-01', '2014-03-31', self.job_activity_id, 520, 40, 1),
            ('2014-04-01', '2014-06-30', self.job_activity_id, 520, 40, 2),
            ('2014-07-01', '2014-09-30', self.job_activity_id, 520, 40, 3),
            ('2014-10-01', '2014-12-31', self.job_activity_id, 520, 40, 4),
        ]:
            self.worked_days_model.create(
                cr, uid, {
                    'date_from': wd[0],
    ...
    def test_create_payslip_wage(self):
        ...
        self.create_worked_days([
            # (date_from, date_to, activity_id, nb_hours, hourly_rate)
            ('2014-01-01', '2014-01-01', self.unpaid_activity_id, 8, 0),
            ('2014-01-02', '2014-01-02', self.job_activity_id, 7, 0),
        ])
        ...
        self.create_worked_days([
            # (date_from, date_to, activity_id, nb_hours, hourly_rate)
            ('2014-01-01', '2014-01-05', self.job_activity_id, 28, 0),
        ])
        ...
        self.create_worked_days([
            # (date_from, date_to, activity_id, nb_hours, hourly_rate)
            ('2014-01-01', '2014-01-05', self.job_activity_id, 10, 0),
        ])
