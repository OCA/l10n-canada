...
from openerp.addons.l10n_ca_hr_payroll.tests.test_hr_cra_t4 import (
...
class TestQuebecPayrollStructure(TestPayrollStructureBase):
        ...
        self.employee_id = self.employee_model.create(cr, uid, {
            ...
            'deduction_ids': [
                (0, 0, {
                    ...
                    ('l10n_ca_hr_payroll.rrsp', 15),
                    ('l10n_ca_qc_hr_payroll.qitf', 16),
                    ('l10n_ca_qc_hr_payroll.qitj', 17),
                    ('l10n_ca_qc_hr_payroll.qitj1', 18),
                    ('l10n_ca_qc_hr_payroll.qitk1', 988),
                    ('l10n_ca_qc_hr_payroll.qite', 1040),
                    ('l10n_ca_qc_hr_payroll.qitq', 21),
                    ('l10n_ca_qc_hr_payroll.qitq1', 22),
                ]
            ]
        }, context=context)
    ...
    def test_create_payslip_low_wage(self):
        ...
        self.create_worked_days([
            ...
            ('2014-01-01', '2014-01-05', self.job_activity_id, 40, 22),
        ])
    ...
    def test_create_payslip_higher_wage(self):
        ...
        self.create_worked_days([
            # (date_from, date_to, activity_id, nb_hours, hourly_rate)
            ('2014-01-01', '2014-01-05', self.job_activity_id, 40, 40),
        ])
    ...
    def test_create_payslip_end_of_year(self):
        ...
        for wd in [
            # (date_from, date_to, activity_id, nb_hours, hourly_rate)
            ('2014-01-01', '2014-03-31', self.job_activity_id, 520, 45, 1),
            ('2014-04-01', '2014-06-30', self.job_activity_id, 520, 45, 2),
            ('2014-07-01', '2014-09-30', self.job_activity_id, 520, 45, 3),
            ('2014-10-01', '2014-12-31', self.job_activity_id, 520, 45, 4),
        ]:
